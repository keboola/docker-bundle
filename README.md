...
- Konfigurace - chcem ukládat konfigurace imagů, chcem tak teda ukládat i konfigurace jednotlivejch použití imagů (model podobnej jako luckyguessu - `/keboola-next-order/run`, `/keboola-next-order/configs`)
