    ...
    public function getConfigTreeBuilder()
    {
        ...
        $root->children()
            ...
            ->arrayNode('staging_storage')
                ...
                ->children()
                    ->enumNode('input')
                        ->values(['local', 's3', 'abs', 'none', 'workspace-snowflake', 'workspace-redshift', 'workspace-synapse'])
                        ->defaultValue('local')
                    ->end()
                    ->enumNode('output')
                        ->values(['local', 'none', 'workspace-snowflake', 'workspace-redshift', 'workspace-synapse'])
                        ->defaultValue('local')
                    ->end()
                ->end()
            ->end()
