...
class LoggerTest extends BaseContainerTest
{
    ...
    public function testGelfLogUdp()
    {
        $script = [
            'import subprocess',
            'import sys',
            'subprocess.call([sys.executable, "-m", "pip", "install", "--disable-pip-version-check", "--default-timeout=600", "pygelf"])',
            'import logging',
    ...
    public function testGelfLogInvalid()
    {
        ...
        $script = [
            'import subprocess',
            'import sys',
            'subprocess.call([sys.executable, "-m", "pip", "install", "--disable-pip-version-check", "--default-timeout=600", "pygelf==0.3.1"])',
            'import logging',
            'import pygelf',
            'import os',
    ...
    public function testGelfLogInvalidMessage()
    {
        $script = [
            'import subprocess',
            'import sys',
            'subprocess.call([sys.executable, "-m", "pip", "install", "--disable-pip-version-check", "--default-timeout=600", "logging_gelf"])',
            'import logging',
