...
class ContainerTest extends \PHPUnit_Framework_TestCase
{
    public function testRun()
    {
        ...
        $fs->mkdir($tableDir);
        $container = new Docker\Mock\Container('docker-container-test', $image, $log, $containerLog, $dataDir, [], 'not-used');
...
EOF;
    ...
    public function testRunCommand()
    {
        ...
        $container = new Container('docker-container-test', $image, $log, $containerLog, '/tmp', $envs, 'not-used');
    ...
    public function testInspectCommand()
    {
        ...
        $image = Image::factory($encryptor, $log, $imageConfiguration, true);
        $temp = new Temp();
        $container = new Container('docker-container-test', $image, $log, $containerLog, $temp->getTmpFolder(), [], 'not-used');
